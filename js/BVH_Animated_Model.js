...
function load_GLTF_Model() {
  ...
  gltfLoader.load("models/DamagedHelmet.gltf", function (meshGroup) {
    // Triangles: 15,452
...
function initSceneData() {
  ...
  pathTracingUniforms.tMetallicRoughnessMap = {
    type: "t",
    value: metallicRoughnessMap,
  };
  pathTracingUniforms.tNormalMap = { type: "t", value: normalMap };
  pathTracingUniforms.uGLTF_Model_Position = {
    type: "v3",
    value: new THREE.Vector3(),
  };
  pathTracingUniforms.uGLTF_Model_InvMatrix = {
    type: "m4",
...
function updateVariablesAndUniforms() {
  ...
  GLTF_Model_Mesh.position.set(
    100 * Math.cos(animationTimer * 0.05),
    20 * (Math.sin(animationTimer * 0.2) + 1.5),
    120 * Math.sin(animationTimer * 0.05) - 50
  );
  ...
  pathTracingUniforms.uGLTF_Model_InvMatrix.value
    .copy(GLTF_Model_Mesh.matrixWorld)
    .invert();
