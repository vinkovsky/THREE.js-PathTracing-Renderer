...
function initTHREEjs() {
  ...
  pathTracingUniforms.tPreviousTexture = {
    type: "t",
    value: screenCopyRenderTarget.texture,
  };
  pathTracingUniforms.tBlueNoiseTexture = {
    type: "t",
    value: blueNoiseTexture,
  };

  pathTracingUniforms.uCameraMatrix = {
    type: "m4",
  ...
  fileLoader.load(
    ...
    function (vertexShaderText) {
      ...
      fileLoader.load(
        "shaders/" + demoFragmentShaderFileName,
  ...
  screenCopyUniforms = {
    tPathTracedImageTexture: {
      type: "t",
      value: pathTracingRenderTarget.texture,
    },
  };
